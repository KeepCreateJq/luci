...
function index()
	...
	entry({"admin","wifimanager", "wifimanager"}, cbi("admin_wifimanager/networks"), _("Networks"), 60)
	entry({"admin","wifimanager", "config"}, cbi("admin_wifimanager/config"), _("Settings"), 61)
end
